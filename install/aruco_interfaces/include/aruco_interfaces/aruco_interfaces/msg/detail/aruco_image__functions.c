...
aruco_interfaces__msg__ArucoImage__init(aruco_interfaces__msg__ArucoImage * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->ids, 0)) {
    aruco_interfaces__msg__ArucoImage__fini(msg);
    return false;
  }
  // corners
...
aruco_interfaces__msg__ArucoImage__create()
{
  ...
  aruco_interfaces__msg__ArucoImage * msg = (aruco_interfaces__msg__ArucoImage *)allocator.allocate(sizeof(aruco_interfaces__msg__ArucoImage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aruco_interfaces__msg__ArucoImage));
  bool success = aruco_interfaces__msg__ArucoImage__init(msg);
  if (!success) {
...
aruco_interfaces__msg__ArucoImage__Sequence__init(aruco_interfaces__msg__ArucoImage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aruco_interfaces__msg__ArucoImage * data = NULL;

  if (size) {
    data = (aruco_interfaces__msg__ArucoImage *)allocator.zero_allocate(size, sizeof(aruco_interfaces__msg__ArucoImage), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = aruco_interfaces__msg__ArucoImage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        aruco_interfaces__msg__ArucoImage__fini(&data[i - 1]);
      }
...
aruco_interfaces__msg__ArucoImage__Sequence__fini(aruco_interfaces__msg__ArucoImage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      aruco_interfaces__msg__ArucoImage__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aruco_interfaces__msg__ArucoImage__Sequence * array = (aruco_interfaces__msg__ArucoImage__Sequence *)allocator.allocate(sizeof(aruco_interfaces__msg__ArucoImage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = aruco_interfaces__msg__ArucoImage__Sequence__init(array, size);
  if (!success) {
...
aruco_interfaces__msg__ArucoImage__Sequence__destroy(aruco_interfaces__msg__ArucoImage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aruco_interfaces__msg__ArucoImage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
aruco_interfaces__msg__ArucoImage__Sequence__are_equal(const aruco_interfaces__msg__ArucoImage__Sequence * lhs, const aruco_interfaces__msg__ArucoImage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aruco_interfaces__msg__ArucoImage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  aruco_interfaces__msg__ArucoImage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(aruco_interfaces__msg__ArucoImage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    aruco_interfaces__msg__ArucoImage * data =
      (aruco_interfaces__msg__ArucoImage *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aruco_interfaces__msg__ArucoImage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          aruco_interfaces__msg__ArucoImage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aruco_interfaces__msg__ArucoImage__copy(

...
bool aruco_interfaces__msg__aruco_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interfaces.msg._aruco_image.ArucoImage", full_classname_dest, 44) == 0);
  }
  aruco_interfaces__msg__ArucoImage * ros_message = _ros_message;
  {  // ids
...
{
  /* NOTE(esteve): Call constructor of ArucoImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interfaces.msg._aruco_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoImage");

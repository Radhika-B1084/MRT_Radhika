...
static const _ArucoDetect_Request_type_support_symbol_names_t _ArucoDetect_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_interfaces, srv, ArucoDetect_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aruco_interfaces, srv, ArucoDetect_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aruco_interfaces, srv, ArucoDetect_Request)() {
  return &::aruco_interfaces::srv::rosidl_typesupport_c::ArucoDetect_Request_message_type_support_handle;
}
...
static const _ArucoDetect_Response_type_support_symbol_names_t _ArucoDetect_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_interfaces, srv, ArucoDetect_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aruco_interfaces, srv, ArucoDetect_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aruco_interfaces, srv, ArucoDetect_Response)() {
  return &::aruco_interfaces::srv::rosidl_typesupport_c::ArucoDetect_Response_message_type_support_handle;
}
...
static const _ArucoDetect_type_support_symbol_names_t _ArucoDetect_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_interfaces, srv, ArucoDetect)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aruco_interfaces, srv, ArucoDetect)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aruco_interfaces, srv, ArucoDetect)() {
  return &::aruco_interfaces::srv::rosidl_typesupport_c::ArucoDetect_service_type_support_handle;
}

...
bool aruco_interfaces__srv__aruco_detect__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interfaces.srv._aruco_detect.ArucoDetect_Request", full_classname_dest, 54) == 0);
  }
  aruco_interfaces__srv__ArucoDetect_Request * ros_message = _ros_message;
  {  // image
...
{
  /* NOTE(esteve): Call constructor of ArucoDetect_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interfaces.srv._aruco_detect");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoDetect_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool aruco_interfaces__srv__aruco_detect__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interfaces.srv._aruco_detect.ArucoDetect_Response", full_classname_dest, 55) == 0);
  }
  aruco_interfaces__srv__ArucoDetect_Response * ros_message = _ros_message;
  {  // ids
...
{
  /* NOTE(esteve): Call constructor of ArucoDetect_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interfaces.srv._aruco_detect");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoDetect_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);

...
bool aruco_interfaces__srv__get_aruco_response__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interfaces.srv._get_aruco_response.GetArucoResponse_Request", full_classname_dest, 65) == 0);
  }
  aruco_interfaces__srv__GetArucoResponse_Request * ros_message = _ros_message;
  {  // image
...
{
  /* NOTE(esteve): Call constructor of GetArucoResponse_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interfaces.srv._get_aruco_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetArucoResponse_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool aruco_interfaces__srv__get_aruco_response__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interfaces.srv._get_aruco_response.GetArucoResponse_Response", full_classname_dest, 66) == 0);
  }
  aruco_interfaces__srv__GetArucoResponse_Response * ros_message = _ros_message;
  {  // ids
...
{
  /* NOTE(esteve): Call constructor of GetArucoResponse_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interfaces.srv._get_aruco_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetArucoResponse_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
